...
public class PartialProductDto {
	...
	public PartialProductDto(Integer productId, String shortName, String longName, Integer quantity, List<Integer> categories,
	...
	public Product toPartialProduct(Product product) {
